...
CreateMarkerFrame::usage=
"CreateMarkerFrame[g, {colorX, colorY, colorZ}, scale:5.0] returns a frame primitive plus the marker point (frame origin) associated with homogeneous transformation g."
...
CreateFrame[g_, colorframe_, scale_:5.0]:=
	Module[{R, p, x, y, z, frame},
		...
		frame = Graphics3D[{
			{Thick, colorframe[[1]], Line[{p, px}]}, 
			{Thick, colorframe[[2]], Line[{p, py}]}, 
			{Thick, colorframe[[3]], Line[{p, pz}]}
		}];
	
	    Return[frame];
	];

CreateMarkerFrame[g_, colorframe_, scale_:5.0]:=
	Module[{R, p, x, y, z, frame},
