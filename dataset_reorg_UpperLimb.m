...
for i = 1 : frame
    ...
    MKNOFR1 = [MKNOFR1 MkNum2];

end

plotName = ['MkOcclusionStatistics' Subject Filename];
figure; bar(OcclMK(1,:),OcclMK(2,:)/frame*100);title('Statistics of Marker Occlusions in % of time span (Only Arm)')
...
figure; plot(MKNOFR,'r*');title('Number of Marker Seen(Only Arm)')
xlabel ('Marker Number')
