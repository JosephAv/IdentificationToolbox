...
%%%%%Rotations
    ...
    R_F_A = RefArm*inv(RefFix);     %Rotation from Fixed ref sys to Arm ref sys
    R_F_F = RefArm*inv(RefForearm); %Rotation from Fixed ref sys to Forearm ref sys
    R_F_H = RefArm*inv(RefHand);    %Rotation from Fixed ref sys to Hand ref sys
